// Updated script.js with image error handling
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    images.forEach(img => {
        ...
        // Add load event to track successful loads
        img.onload = function() {
    ...
    function preloadImages() {
        const imageUrls = [
            ...
            'images/fallback.jpg'  // Also preload the fallback image
        ];
    ...
    function checkImagesFolder() {
        ...
        testImg.onload = function() {
            console.log('Images folder accessible.');
        };
        testImg.onerror = function() {
            console.error('WARNING: Images folder not found or inaccessible!');
            alert('Images folder not found! Please create an "images" folder with the necessary image files.');
        };
        
        // Try to load the fallback image
        testImg.src = 'images/fallback.jpg';
    }
